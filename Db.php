...
class DataBase {
  ...
  /* Получение экземпляра класса. Если он уже существует, то возвращается, если его не было, то создаётся и возвращается */
  ...
  private function __construct() {
    $this->mysqli = new mysqli("localhost", "root", "", "graph_test");
  ...
  public function print_mess($arr){
